...
However, the problem of finding all Nash equilibria in strategic games is a [computationally intensives problem, even in the simple case of two palyers](https://web.mit.edu/tabbott/Public/final.pdf). While *pure* strategy Nash equilibria can, in principle, be found efficiently, for large games the calculation tends to be infeasible. First generation quantun annealers (from D-Wave Systems) use a first iteration of the promised quantum computational speed up to solve some NP-hard problems faster and with better quality. This project gives a quantum annealing solution to the problem of finding all pure strategy Nash equilibria in two-player, non-cooperative games. When improvements to quantum annealers make real-valued solutions more feasible, this project will extend to inlclude quantum solutions for the problem of finding *mixed* strategy Nash equilibria as well. Finally, extension to multi-player games will be explored.
